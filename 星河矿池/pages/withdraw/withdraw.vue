	...
	<view class="page pages">
		<view class="header_bar">
			<view class="header">
				...
				<view class="header-goRight" @click="$tools.jump('./withdrawRecord',currencyId,selectType)"></view> 
			</view> 
		</view> 
		<view class="withdraw">
			<view class="withdrawBox">
				...
				<view class="withdrawBox-list">
					...
					<view class="withdrawBox-list-input withdrawBox-list-input--address">
						<input type="text" placeholder="输入或长按粘贴地址" placeholder-style="color:#999999" v-model="address" class=""/>
		...
		watch:{
			num(){
				if(this.num == ''){
					...
					if (this.currencyInfoList[this.tabsActive].percentage != null) {
