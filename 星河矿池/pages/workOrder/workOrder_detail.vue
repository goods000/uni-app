<template>
	<view class="pages">
		<view class="header_bar">
			<view class="header header_fixed">
				<view class="header-back" @click="$tools.back(1)"></view>
				<view class="header-title">工单</view>
				<view class="header-right" @click="openPopup('closePopup')">结束</view>
			</view> 
		</view> 
		<!-- <view class="initHeader initHeader--fixed initHeader--black">
			<view class="initHeader-wrapper">
				...
				<view class="initHeader-right initHeader-right--text" @click="openPopup('closePopup')">结束</view>
			</view>
		</view> -->
		<view class="main">
...
@import '@/common/scss/pages/workOrder/workOrder_detail';
</style>
