			...
			<view class="etiquetaBox">
				<view class="etiquetaBox-wrapper">
					<view class="etiquetaBox-item" @click="$tools.jump('../api/api')">
						<view class="etiquetaBox-item__icon"><image :src="'../../static/index/icon-etiqueta-01-' + pageTheme + '.png'" mode="widthFix"></image></view>
						<view class="etiquetaBox-item__label">API授权</view>
					</view>
					<view class="etiquetaBox-item" @click="$tools.jump('../assets/assets')">
						<view class="etiquetaBox-item__icon"><image :src="'../../static/index/icon-etiqueta-02-' + pageTheme + '.png'" mode="widthFix"></image></view>
					...
					<view class="etiquetaBox-item" @click="$tools.jump('../quantification/quantification_rewardRecord')">
						<view class="etiquetaBox-item__icon"><image :src="'../../static/index/icon-etiqueta-03-' + pageTheme + '.png'" mode="widthFix"></image></view>
						<view class="etiquetaBox-item__label">量化收益</view>
					</view>
					<view class="etiquetaBox-item" @click="$tools.jump('../ranking/ranking')">
						<view class="etiquetaBox-item__icon"><image :src="'../../static/index/icon-etiqueta-04-' + pageTheme + '.png'" mode="widthFix"></image></view>
						<view class="etiquetaBox-item__label">排行榜单</view>
					</view>
					<view class="etiquetaBox-item" @click="goLink('https://www.huobi.li/zh-cn/topic/invited/?invite_code=8imm3')">
					...
					<view class="etiquetaBox-item" @click="goLink('https://accounts.binancezh.io/zh-CN/register?ref=13715138')">
					...
					<view class="etiquetaBox-item" @click="goLink('https://www.okex.win/join/4683592')">
					...
					<view class="etiquetaBox-item" @click="goLink('https://www.gateio.ch/signup/758624')">
						<view class="etiquetaBox-item__icon"><image src="../../static/index/icon-etiqueta-08.png" mode="widthFix"></image></view>
						<view class="etiquetaBox-item__label">GATE</view>
					</view>
				</view>
			</view>
				...
				<view class="rankingBox-wrapper">
					...
					<view class="rankingBox-body">
						...
						<view class="rankingBox-item" v-for="(item, index) in rankingList" :key="index">
							...
							<view class="rankingBox-item__userName">{{ item.name | conceal(3) }}</view>
			...
			<view class="quotesBox">
				<view class="quotesBox-wrapper">
					...
					<view class="quotesBox-body">
						<view class="initNoData" v-if="commTradeList.length == 0">暂无数据</view>
	...
	data() {
		return {
			...
			dotsStyles: {
				...
				selectedBackgroundColor: '#EC6B00'
			},
				...
				res => {
					...
					if (res.code == 0) {
						if (res.obj.list != null) {
							this.rankingList = res.obj.list.splice(0, 3);
						}
					}
				}
			);
