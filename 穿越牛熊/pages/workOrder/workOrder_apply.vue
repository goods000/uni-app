		...
		<view class="initFormBox">
			<view class="initFormBox-wrapper">
				<view class="initFormBox-item">
					<view class="initFormBox-item__label">工单标题</view>
					<view class="initFormBox-item__input"><input type="text" placeholder-class="initFormBox-item__placeholder" placeholder="请输入您的工单标题" v-model="title" /></view>
				</view>
				<view class="initFormBox-item">
					<view class="initFormBox-item__label">问题描述</view>
					<view class="initFormBox-item__textarea">
						<textarea type="text" placeholder-class="initFormBox-item__placeholder" :maxlength="maxMessageLength" placeholder="请详述您遇到的问题" v-model="message" />

						<view class="initFormBox-item__textarea-max">{{ messageLength }}/{{ maxMessageLength }}</view>
					</view>
				</view>
			</view>
		</view>
