...
Vue.prototype.$setTarBar = function() {
	...
	uni.setTabBarStyle({
		color: this.$store.state.pageTheme == 'light' ? '#757F8D' : '#FFFFFF',
		selectedColor: this.$store.state.pageTheme == 'light' ? '#EC6B00' : '#EC6B00',
		backgroundColor: this.$store.state.pageTheme == 'light' ? '#FFFFFF' : '#292F3C',
