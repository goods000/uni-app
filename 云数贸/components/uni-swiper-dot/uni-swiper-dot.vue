<template>
	<view class="uni-swiper__warp">
        ...
        'width': (index === current? dots.width:dots.width ) + 'px','height':dots.width/3 +'px' ,'background-color':index !== current?dots.backgroundColor:dots.selectedBackgroundColor,'border-radius':'0px'}"
