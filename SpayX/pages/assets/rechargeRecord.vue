<template>
	<view class="page">
		...
		<view class="header-plate">
			...
			<view class="header-title">{{ i18n.global.recharge }}{{ i18n.global.record }}</view>
		...
		<view class="record-list">
			<view class="record-item" v-for="(item,index) in recordlist" :key="index">
				...
				<view class="count-item">
					...
					<view class="item">{{i18n.assets.successfully }}</view>
				</view>
			</view>
		</view>
	</view>
	...
	.page{
		...
		.record-list{
			.record-item{
				...
				height: 184rpx;
				width: 692rpx;
				background-image: url(../../static/assets/recharge-record-bg.png);
				margin: auto;
				margin-top: 20rpx;
				.coin-plate{
					height: 70rpx;
