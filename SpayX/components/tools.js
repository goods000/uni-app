	...
	uni.setClipboardData({
		...
		success() {
			...
			if (uni.getStorageSync('initLanguage') == 'cn') {
				message = messagesCn.global.copySuccess;
			} else if (uni.getStorageSync('initLanguage') == 'en') {
				message = messagesEn.global.copySuccess;
			}
...
tools.noOpen = () => {
	let message;
	if (uni.getStorageSync('initLanguage') == 'cn') {
		message = messagesCn.global.comingSoon;
	} else if (uni.getStorageSync('initLanguage') == 'en') {
		message = messagesEn.global.comingSoon;
	}
