			...
			<view class="operateBox-wrapper">
				<view class="operateBox-list">
					...
					<view class="operateBox-list__input" :class="{ 'operateBox-list__input--active': isFocus == 0, showCloseBtn: phone != '' }">
						<input @blur="blurInput(0)" @focus="focusInput(0)" placeholder-class="operateBox-placeholder" placeholder="请输入手机号/邮箱" v-model="phone" />
				...
				<view class="operateBox-list">
					...
					<view class="operateBox-list__input" :class="{ 'operateBox-list__input--active': isFocus == 1, showCloseBtn: code != '' }">
						<input @blur="blurInput(1)" @focus="focusInput(1)" placeholder-class="operateBox-placeholder" placeholder="输入验证码" v-model="code" />
						<view class="operateBox-list__fixedBox">
			...
			this.$Ajax(
				...
				res => {
					if (res.code == 0) {
						...
						this.$tools.jump('../operate/forget_next', this.phone, res.obj);
					}
				}
			);
