const messagesCn = {
	...
	// 登录页
	login_info: 'Welcome to the ASEAN International Ecology!',
	login_forget: 'Forgot password',
	login_phone: 'Mobile login',
	login_email: 'Mailbox login',
	login_password_gesture: 'Gesture password',
	login_password_finger: 'Fingerprint recognition',
	login_password_default: 'Account password',
	login_toast_1: 'The user has not set the gesture password yet',
	login_toast_2: 'This user has not set fingerprint login yet',
	login_toast_3: 'This device does not support fingerprint recognition',
	login_toast_4: 'This device does not have a password lock screen and cannot use fingerprint recognition',
	login_toast_5: 'This device has not entered the fingerprint, please go to the settings to open',
	login_toast_6: 'The account is not set to login, please select another way to log in',
	login_toast_7: 'Fingerprint matching failed, please re-enter',
	login_toast_8: 'The number of fingerprint recognition failures exceeds the limit, please use other methods for authentication',
	login_toast_9: 'Unrecognized',
	login_toast_10: 'Fingerprint recognition failed, please try again',
	login_toast_11: 'Verify the phone fingerprint by the home button to log in',
	login_toast_12: 'Fingerprint recognition...',
	login_more_action: 'More ways',

	// 注册页
	register_phone: 'Mobile register',
	register_email: 'Mailbox register',
	register_info_1: 'I have read and agree',
	register_info_2: 'Service Agreement',
	register_info_3: 'Existing account',
	register_info_4: 'Go to login',

	// 手势
	gesture_please_enter: 'Please enter a gesture password',
	gesture_notSame: 'Two gestures are inconsistent',
	gesture_confirm: 'Please confirm gesture settings',

	// 忘记密码页

	// 首页
	index_tabs_1: 'Mainstream',
	index_tabs_2: 'Increase',
	index_tabs_3: 'Lowering',
	index_volume: 'Volume',


	index_title: 'ASEAN International Ecology',
	index_navigationBox_title: 'Plan',
	index_navigationBox_item_1: 'Market',
	index_navigationBox_item_2: 'Hash',
	index_navigationBox_item_3: 'Asset',
	index_navigationBox_item_4: 'OTC',
	index_navigationBox_item_5: 'Team',
	index_navigationBox_item_6: 'Node',
	index_navigationBox_item_7: 'Proxy',
	index_navigationBox_item_8: 'Record',
	index_navigationBox_item_9: 'Safety',
	index_navigationBox_item_10: 'Feedback',
	index_navigationBox_item_11: 'E-Shop',
	index_navigationBox_item_12: 'Recreation',
	index_gallerybox_title: 'Wallet',
	index_menu_login: 'Please log in',
	index_menu_info: 'Welcome to the ASEAN International Ecology',
	index_menu_item_1: 'Service',
	index_menu_item_2: 'Feedback',
	index_menu_item_3: 'Setting',
	index_menu_item_4: 'About us',
	index_menu_item_5: 'Exit',

	// 哈希池
	hash_title: 'Hash',
	hash_popup_title: 'warm tips',
	hash_popup_info_1: 'Deposit ',
	hash_popup_info_2: ' to the hash pool? ',
	hash_toast_1: 'Successful transfer',
	hash_toast_2: 'The number of inputs cannot be greater than the available number',
	hash_cloud: 'Hash cloud',
	hash_lenght: 'Hash quantity',
	
	// 超级节点
	superNode_title: 'Super node',
	superNode_team: 'Team node',
	superNode_info_1: 'My node',
	superNode_desc_title: 'Super Node Description',
	superNode_desc_1: 'Ordinary node: total performance under the umbrella reaches 4,200,000 hash clouds',
	superNode_desc_2: 'Primary node: each of the three lines under the umbrella trains a common node to upgrade to the primary node, and takes 5% of the certificate of the new performance under the umbrella',
	superNode_desc_3: 'Intermediate node: each of the three lines under the umbrella trains one primary node to upgrade to the intermediate node, and takes 10% of the certificate of the new performance under the umbrella',
	superNode_desc_4: 'Advanced node: each of the three lines under the umbrella is upgraded to an advanced node, and 15% of the certificate of the new performance under the umbrella is taken',
	superNode_desc_5: 'Super Node: Each of the three lines under the umbrella will be upgraded to a super node, and 20% of the certificate of the new performance will be added under the umbrella',
	superNode_level_0: 'No node',
	superNode_level_1: 'Normal node',
	superNode_level_2: 'Primary node',
	superNode_level_3: 'Intermediate node',
	superNode_level_4: 'Advanced node',
	superNode_level_5: 'SuperNode',
	
	// 代理系统
	proxy_title: 'Proxy system',
	proxy_gradientCard_1: 'Total performance',
	proxy_gradientCard_2: 'My level',
	proxy_gradientCard_3: 'Under the umbrella',
	proxy_level_0: 'No proxy',
	proxy_level_1: 'Zone agent',
	proxy_level_2: 'City agent',
	proxy_level_3: 'Provincial agent',
	proxy_info_1: 'Condition: 500,000 u under the umbrella, 50 members under the umbrella',
	proxy_info_2: 'Equity: 5% bonus for new performance in this district',
	proxy_info_3: 'Condition: 5 million u under umbrella, 500 under umbrella',
	proxy_info_4: 'Equity: 10% bonus for new performance in this district',
	proxy_info_5: 'Condition: 50 million u under the umbrella',
	proxy_info_6: 'Equity: 15% of the new performance in this area',

	// 意见反馈
	feedback_toast_1: 'Please describe your problem or suggestion in detail, we will follow up in time to resolve. ',
	feedback_toast_2: 'Please don\'t submit empty content! ',
	
	// 行情页
	coinTrade_canUse: 'Available',
	coinTrade_withdrawal: 'Withdrawal',
	coinTrade_transactionAmount: 'Transaction amount',
	cointrade_unfilledCommission: 'Unfilled',
	cointrade_historicalCommission: 'Historical',
	cointrade_latestDeal: 'Latest deals',
	cointrade_commissionPrice: 'Trust price',
	cointrade_averageTransactionPrice: 'The average price of the transaction',
	cointrade_numberOfOrders: 'Number of delegates',
	cointrade_theNumberOfTransactions: 'Number of transactions',

	// 星际协议
	rocket_mirrorThrough: 'IBE',
	rocket_mapping: 'IB',
	rocket_benRayAction: 'IBK',
	rocket_level_1: 'Level',
	rocket_level_2: '',
	rocket_noOpen_1: 'The event is not open yet',
	rocket_noOpen_2: 'The event is not open yet, please look forward to',
	rocket_end_1: 'End of event',
	rocket_end_2: 'Please stay tuned for the latest issue',
	rocket_info_1: 'IB exchange',
	rocket_info_2: '',
	rocket_g_data_1: 'All remaining',
	rocket_g_data_2: 'My balance',
	rocket_g_data_3: 'Today remaining',
	rocket_g_data_4: 'All remaining amount',
	rocket_g_data_5: 'My available',
	rocket_g_data_6: 'Current exchange ratio',
	rocket_g_data_7: 'Exchange amount',
	rocket_g_data_8: 'My available',
	rocket_g_data_9: 'Exchange amount',
	rocket_g_data_8: 'My available',
	rocket_rocord_tabs_1: 'Exchange',
	rocket_rocord_tabs_2: 'Static release',
	rocket_rocord_tabs_3: 'Team acceleration',
	rocket_rocord_tabs_4: 'Buy rewards',
	rocket_rocord_tabs_5: 'Gift',
	rocket_rocord_tabs_6: 'Purchase',
	rocket_rocord_tabs_7: 'Burn release',
	rocket_rocord_tabs_8: 'Team reward',
	rocket_ibk_title: 'My ibk',
	rocket_ibk_note_1: 'Ibk dividend description',
	rocket_ibk_note_2: '(1), ibk total 21 million, ibk as the stock\'s equity certificate, used for equity dividends and ecological rights and game ecological applications.',
	rocket_ibk_note_3: '(2), holding ibk can mine and pay dividends.',
	rocket_ibk_note_4: '(3), holding an ibk, enjoy a daily dividend of 0.3% of the currency.',
	rocket_ibk_note_5: '(4), the ibk of the dividend is not locked, and it is settled every 24 hours.',
	rocket_dividendRecord: 'Dividend record',

	// 资产
	property_title: 'My assets',
	property_assetFolding: 'Total account assets',
	property_tabs_1: 'Mobile wallet',
	property_tabs_1_assetFolding: 'Mobile wallet total assets equivalent',
	property_tabs_2: 'Hash Wallet',
	property_tabs_2_assetFolding: 'Hash Wallet Total Assets',
	property_tabs_3: 'Super Wallet',
	property_tabs_3_assetFolding: 'Super Wallet Total Assets',
	property_hideSmall: 'Hide small currency',

	// 充币
	rechange_tips_title: 'Warm tips',
	rechange_tips_info_1: 'Usdt wallet address prohibits recharging of assets other than usdt. any non-usdt asset recharge will not be retrievable.',
	rechange_tips_info_2: 'The recharge address does not change frequently. please confirm the address before recharging.',
	rechange_tips_info_3: 'If the eth token recharge only supports the ethereum standard transfer method, the use of other methods of the currency can not be accounted for temporarily, please understand.',
	rechange_tips_info_4: 'The wallet address is forbidden to recharge',
	rechange_tips_info_5: 'Other assets than \', any not',
	rechange_tips_info_6: 'The asset recharge will not be retrievable.',
	rechange_tips_info_7: 'The recharge address does not change frequently. please confirm the address before recharging.',

	// 提币
	withdrawal_text_1: 'Enter or long press paste address',
	withdrawal_text_2: 'Number of coins',
	withdrawal_text_3: 'Minimum coin amount:',
	withdrawal_text_4: 'Number of coins available',
	withdrawal_text_5: 'All',
	withdrawal_text_6: 'Handling fee',
	withdrawal_text_7: 'Fund password',
	withdrawal_text_8: 'Please enter the funds password',
	withdrawal_text_9: 'Sms verification code',
	withdrawal_text_10: 'Please enter sms verification code',
	withdrawal_tips_title: 'Warm tips',
	withdrawal_tips_1: 'The minimum number of coins is:',
	withdrawal_tips_2: 'In order to ensure the security of the funds, please be patient when your account security policy changes, password changes, we will manually review. ',
	withdrawal_tips_3: 'Please be sure to check the security of your computer and browser to prevent the information from being tampered with or leaked. ',
	withdrawal_tips_4: 'Number of arrivals',
	withdrawal_tips_5: 'Remove instructions',
	withdrawal_tips_6: 'Withdrawal limit',
	withdrawal_tips_7: 'Minimum amount',
	withdrawal_tips_8: 'Single day withdrawal limit',
	withdrawal_tips_9: 'The platform does not charge a withdrawal fee, the user only has to pay the necessary network fee (miner fee)',
	withdrawal_tips_10: 'We will process the optimal algorithm according to the handling fee you filled in, reduce your handling fee and increase the speed of theoretical block confirmation. please refer to the actual arrival time for the specific time of arrival.',
	withdrawal_tips_11: 'Know it',
	
	// 转账
	transfer_title: 'Transfer',
	transfer_form_title_1: 'Party account',
	transfer_form_toast_1: 'Please enter the other party',
	transfer_form_toast_2: 'Please select currency',
	transfer_form_toast_3: 'Please enter the transfer amount',
	transfer_tips_title: 'Warm Tips',
	transfer_tips_info_1: 'The minimum transfer amount is:',
	transfer_tips_info_2: 'The maximum transfer amount is:',
	transfer_tips_info_3: 'Please confirm the other party\'s account when transferring, so as to avoid asset loss.',
	transfer_toast_1: 'OK transfer? ',
	transfer_toast_2: 'Transfer successfully',
	transfer_toast_3: 'Please fill in the username',
	transfer_toast_4: 'Please select the currency type',
	transfer_toast_5: 'Please fill in the quantity',
	transfer_toast_6: 'The minimum transferable amount is',
	transfer_toast_7: 'Maximum transferable amount is',
	transfer_toast_8: 'Please fill in the transaction password',

	// 转账记录
	transfer_record_title: 'Transfer record',
	transfer_record_tabs_1: 'Transfer out',
	transfer_record_tabs_2: 'Transfer in',
	
	// 互转
	exchange_title: 'Exchange',
	exchange_info_1: 'Exchange amount',
	exchange_toast_1: 'Exceeded the upper limit',
	exchange_toast_2: 'Exchange success',
	exchange_toast_3: 'Please enter the number of redemptions',
	
	// 兑换记录
	exchange_record_title: 'Exchange record',

	// 我的
	mine_authentication: 'Verified',
	mine_authentication_status_1: 'In certification',
	mine_authentication_status_2: 'Verified',
	mine_authentication_status_3: 'Failed',
	mine_authentication_status_4: 'Uncertified',
	mine_securityCenter: 'Security center',
	mine_myTeam: 'My team',
	mine_OTC: 'OTC transaction',
	mine_onlineService: 'Online customer service',
	mine_transactionRecord: 'Transaction record',
	mine_IB_news: 'Love currency information',
	mine_bankCardManagement: 'Bank card management',
	mine_starfighting: 'Star wars',
	mine_aboutOur: 'About us',
	mine_logOut: 'Logout',
	mine_setting: 'Setting',
	...
	// 人脸识别
	face_info_1: 'Record a video that reads the following numbers yourself',
	face_info_2: 'Please use the front camera',
	face_info_3: 'Please read it in Mandarin',
	face_info_4: 'Video duration 3-5 seconds',
	face_button: 'Get started',
	...
	myTeam_copyLink: 'Copy share link',
	myTeam_invitationRecord: 'Invitation record',
	myTeam_card_title_1: 'Direct push',
	myTeam_card_title_2: 'Team',
	myTeam_card_title_3: 'Team performance',
	myTeam_card_title_4: 'Personal rebate',
	myTeam_sharePoster: 'Share your exclusive poster',
	myTeam_card_new_title_1: 'Invited friends',
	myTeam_card_new_title_2: 'My direct push',
	
	// 全部记录集合
	allRecord_title: 'Record',
	allRecord_tabs_title_1: 'Charge',
	allRecord_tabs_title_2: 'Withdraw',
	allRecord_tabs_title_3: 'Transfer',
	allRecord_tabs_title_4: 'Transfer Out',
	allRecord_tabs_title_5: 'Exchange',
	allRecord_tabs_title_6: 'Hash',
	allRecord_tabs_title_7: 'Direct reward',
	allRecord_tabs_title_8: 'Team reward',

	// 星际战队
	starfighting_title: 'Star wars',
	starfighting_card_1: 'The team',
	starfighting_card_2: 'Direct',
	starfighting_card_3: 'Team',
	starfighting_card_4: 'Total',
	starfighting_title_1: 'Push',
	starfighting_title_2: 'Level',
	starfighting_title_3: 'Join',
	starfighting_title_4: 'Brand join',
	starfighting_title_5: 'Money',
	...
	otc_toast_cancel: 'After cancellation, the order will not be restored',
	otc_toast_confirm: 'Please confirm the order is correct, then operate again',
	otc_toast_noproplem: 'Please confirm that the order is correct, click OK to receive the payment.',
	otc_toast_doCancel: 'You have canceled the payment operation',
	...
	set_weirz: 'Unauthorized',
	set_renzz: 'Authenticating',
	set_yirz: 'Authenticated',
	set_renzsb: 'Failed',
	set_shoukfs: 'Payment',
	set_jiaoyyz: 'Trade verify',
	set_never: 'Never enter a transaction password',
	set_out: 'Out',
	set_caozcg: 'Success',
	set_shousmm: 'Gesture password',
	set_xiugsjh: 'Change phone',
	set_xiugma: 'Change pwd',
	set_xiugnc: 'Change nick',
	set_lang: 'Language',

	//修改密码
	xgmm_title: 'Change password',
	xgmm_1: 'Old password',
	xgmm_2: 'New password',
	xgmm_3: 'Confirm password',

	//设置 -- 收款方式
	skfs_title: 'Payment method',
	skfs_bankcard: 'Bank card',
	skfs_alipay: 'Alipay',
	skfs_wechat: 'Wechat',
	skfs_qusz: 'To set',
	skfs_yiqy: 'Activated',
	...
	//银行卡设置
	bank_title: 'Bank card settings',
	bank_type: 'Beneficiary bank',
	bank_id: 'Bank card number',
	...
	//支付宝设置
	alipay_title: 'Alipay settings',

	//微信设置
	wechat_title: 'Wechat settings',

	//设置页面下拉框
	setDown_s1: 'Never enter a trade password',
	setDown_s2: 'No password for 6 hours',
	setDown_s3: 'Always verify passwords',
	setDown_s4: 'Change login password',
	setDown_s5: 'Change transaction password',
	setDown_s6: 'Retrieve transaction password',

	//关于我们
	aboutUs_gywm: 'About us',
	aboutUs_bb: 'Current version',
	aboutUs_info: 'Ib exchange is the world\'s first pow+pos innovative encrypted digital asset trading platform created by the swedish nordic exchange and the world\'s top technical team.',
	aboutUs_fwxy: 'Service agreement',
	aboutUs_ystk: 'Privacy policy',
	aboutUs_bbrz: 'Version log',
	aboutUs_dqbb: 'Current version',
