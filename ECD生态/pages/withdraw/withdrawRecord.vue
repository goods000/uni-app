	...
	export default {
		data() {
			return {
				...
				selectType:'',
				recordList: [
					{currencyName:'USDT',id:1,createTime:'2122-2-23 23:23',quantity:12,statusStr:'EDD',address:'0xdai165sf1d45vdnf1fz1n1f10b12fb'}
				],
			}
		},
		onLoad(option) {
...
<style lang="scss" scoped>
	@import '../recharge/scss/rechargeRecord';
	.header_fixed + view{
