      ...
      <view class="main" :class="item.style">
        ...
        <view class="msg">
          ...
          <view v-if="item.msg.type == 'img' || item.msg.type == 'video'">
            ...
            />
            <video v-if="item.msg.type == 'video'" :src="item.msg.data" object-fit="fill" class="demoVideo"
			:controls="true" :loop="true" :poster="item.msg.data" :show-center-play-btn="true" :show-fullscreen-btn="true"
			style="width:300rpx;position: relative;z-index: 1;"/>
			<!-- @play="playVideo(item.msg.data)" -->
          </view>
