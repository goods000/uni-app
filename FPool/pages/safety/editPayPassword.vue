		...
		<view class="safety">
			<view class="header_bar">
				<view class="header">
					...
					<view class="header-title">{{ i18n.global.modify }}{{ i18n.safety.list_03 }}</view>
				</view> 
			</view> 
			...
			<view class="safety-list">
				...
				<view class="safety-list-input">
					<input :password="!eyeShowHideArray[2].show" :placeholder="i18n.password.placeholder_02" placeholder-style="color:#999999" v-model="newPsd"/>
					<view class="safety-list-input-image">
			...
			<view class="safety-list">
				...
				<view class="safety-list-input">
					<input :password="!eyeShowHideArray[3].show" :placeholder="i18n.password.placeholder_03" placeholder-style="color:#999999" v-model="againPsd"/>
					<view class="safety-list-input-image">
				...
				this.$Ajax(
					...
					res => {
						...
						if (res.code == 0) {
							...
							this.againPsd = '';
							this.code = '';
							this.$tools.toastJump(this.i18n.global.modifySuccess, './safety');
						}
					}
				);
			}
