					...
					<view class="newsletterBox-list" v-for="(item, index) in newsletter" :key="index">
						...
						<view class="newsletterBox-list__plane">
							...
							<view class="newsletterBox-list__button">
								<view class="newsletterBox-list__button-btn newsletterBox-list__button-btn--good" @click="goodORbad(item.id, index, 1)">{{ i18n.information.operate_01 }}({{ item.upCounts }})</view>
								<view class="newsletterBox-list__button-btn newsletterBox-list__button-btn--bad" @click="goodORbad(item.id, index, 0)">{{ i18n.information.operate_02 }}({{ item.downCounts }})</view>
							</view>
						</view>
					</view>
				</view>
