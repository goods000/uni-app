			...
			<view class="initHeader-wrapper">
				<view class="initHeader-tabs">
					<view class="initHeader-tabs__wrapper">
						<view class="initHeader-tabs__item" :class="{ 'initHeader-tabs__item--active': headerTabsActive == 0 }" @click="changeHeaderTabsActive(0)">资讯</view>
						<view class="initHeader-tabs__item" :class="{ 'initHeader-tabs__item--active': headerTabsActive == 1 }" @click="changeHeaderTabsActive(1)">快讯</view>
					</view>
				</view>
			</view>
		</view>
