<template>
	<view class="pages">
		...
		<view class="orderDetails">
			<image src="../../static/order/icon-order-success.png" mode="widthFix" class="orderDetails-image" v-if="orderInfo.status == 1"></image>
			<image src="../../static/order/icon-order-success.png" mode="widthFix" class="orderDetails-image" v-else></image>
			...
			<view class="orderDetails-item" v-else>
