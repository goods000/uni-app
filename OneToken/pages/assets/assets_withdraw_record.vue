	...
	<view class="pages">
		...
		<view class="listBox">
			<view class="listBox-wrapper">
				...
				<view class="listBox-list" v-for="(item, index) in recordList" :key="index" @click="$tools.jump('../assets/assets_withdraw_detail', item.id)">
					...
					<view class="listBox-list__footer">
						<view class="listBox-list__address">{{ item.address }}</view>
					</view>
				</view>
			</view>
		</view>
...
@import '/scss/assets_withdraw_record';
</style>
