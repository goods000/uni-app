		...
		<view class="infoBox">
			<view class="infoBox-wrapper">
				...
				<view class="infoBox-list">
					...
					<view class="infoBox-list__data">{{ i18n.global.withdraw }}</view>
				</view>
				<view class="infoBox-list">
					<view class="infoBox-list__title">{{ i18n.global.address }}</view>
				...
				<view class="infoBox-list">
					<view class="infoBox-list__title">{{ i18n.global.serviceCharge }}</view>
