		...
		<view class="main">
			<view class="newsBox">
				<view class="newsBox-wrapper">
					...
					<rich-text :nodes="noticeContent.content" class="textImage" style="color:#d0d0d0;line-height: 1.8;font-size: 28upx;"></rich-text>
				</view>
			</view>
		</view>
	</view>
			...
			this.$Ajax(
				...
				res => {
					...
					if (res.code == 0) {
						...
						let reg = /\\/g;
						let content = res.obj.content.content;
						content = content.replace(reg, '');
						this.noticeContent.content = content;
