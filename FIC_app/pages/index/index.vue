				...
				<view class="index-asset-box">
					<view class="index-asset-count">
						<view class="index-asset-top">
							...
							<view class="index-asset-top-txt">总算力(T)</view>
						</view>
						<view class="insex-asset-top-data">{{userList.levelInvest}}</view>
					</view>
					...
					<view class="in_li" v-for="(item, index) in coinList" :key="index">
						<view class="coin_title_l">
							<view class="coin_name">
								...
								<view class="coin_b" v-if="item.curr.toUpperCase() != 'USDT'" >/USDT</view>
							</view>
						</view>
						<view class="coin_title_l">
