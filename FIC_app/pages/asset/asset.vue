			...
			<view class="asset-box-data" :style="'background-image: url('+ src +')'">
				<view class="asset-tab">
					<view class="asset-tab-list">
						<view class="asset-tab-list-txt" :class="{ 'active': tabsActive == 1 }" @click="changeTabsActive(1)">FIC</view>
						<view class="asset-tab-list-txt" :class="{ 'active': tabsActive == 2 }" @click="changeTabsActive(2)">USDT</view>
					</view>
				</view>
			...
			<view class="asset-mt">
				<view class="asset-big-box">
					<view class="tips_view">
						...
						<view class="tips_view_right" @click="$tools.jump('../asset/assetRecord')">
	...
	export default {
		data() {
			return {
				...
				pages:1,
				tabsActive: 1,
				src: '../../static/asset/icon-asset-01.png',
				type_c:'FIC'
			}
		},
		// onReachBottom() {
