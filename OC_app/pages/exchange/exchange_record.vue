							...
							<view class="ticketBox-itemBox__wrapper">
								...
								<view class="ticketBox-itemBox__item">
									<view class="ticketBox-itemBox__item-label">
										...
										{{ tabsActive != 2 ? '实际成交' : '成交额' }}({{ item.currencyName }})
									</view>
...
export default {
	data() {
		return {
			...
			recordList: [
				// {tradeType:0,tradeTypeStr:'买',tradeCurrencyName:'OC',currencyName:'USDT',charge:'0.01245',quantity:7.12,tradeQuantity:10,tradePrice:6.5,initOrderTime:'00:32 06/11',createTime:'2021-06-11 00:32:39',price:10},
				// {tradeType:1,tradeTypeStr:'卖',tradeCurrencyName:'XZ',currencyName:'USDT',charge:'0.01245',quantity:5.22,tradeQuantity:10,tradePrice:6.5,initOrderTime:'00:32 06/11',createTime:'2021-06-11 00:32:39',price:10}
			], //当前委托
