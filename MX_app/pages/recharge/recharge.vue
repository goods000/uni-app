<template>
	<view class="pages">
		<view class="header_bar header_bg" v-show="showBackBtn">
			<view class="header">
				<view class="header-back" @click="$tools.back(1)"></view>
				<view class="header-title">充币</view>
				<view class="header-right" @click="$tools.jump('./rechargeRecord')">
		...
		<view class="recharge">
			<view class="recharge-box">
				...
				<view class="recharge-cion-t">充币地址</view>
				...
				<view class="qecode-code-btn" @click="$tools.copy(val)">复制</view>
			</view>
