	...
	<view class="login">
		...
		<view class="loginFrom">
			<view class="loginFrom-box">
				...
				<input type="text" placeholder="请设置用户名（少于10字）" v-model="acount" />
			</view>
			<view class="loginFrom-box">
				<view class="loginFrom-icon">
			...
			<view class="loginFrom-box">
				...
				<input type="text" placeholder="请输入您的推荐码" value="" v-model="invite"/>
			</view>
		...
		<view class="btn-active-login" @click="register()">确定</view>
		
		<view class="register-title" @click="$tools.jump('./login')">
			<text class="title">已有账号，</text>返回登录
		</view>
	</view>
</template>
