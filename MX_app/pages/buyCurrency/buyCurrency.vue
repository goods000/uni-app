		...
		<view class="form">
			<view class="form-box">
				...
				<view class="form-group">
					...
					<view class="form-data">1USDT={{ usdt_to_slc_scale }}SLC</view>
				</view>
			</view>
			<view class="form-box mt-mb">
				<view class="form-group">
					<view class="form-label">购买数量</view>
					<input type="text" placeholder="请输入您的购买数量" v-model="num" />
				</view>
				<view class="form-group">
					<view class="form-label">手续费</view>
					<input type="text" placeholder="" :value="usdt_to_slc_fee_scale + 'USDT'" disabled />
				</view>
				<view class="form-group">
				...
				<view class="form-group">
					...
					<input type="text" placeholder="" :value="actual_num + 'SLC'" disabled/>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			getConvert() {
				this.$Ajax('/convert/index', {}, res => {
						if (res.code == 0) {
							this.usdt_to_slc_scale = res.usdt_to_slc_scale
							this.usdt_to_slc_fee_scale = res.usdt_to_slc_fee_scale
						}
					}
				);
			},
		...
		computed:{
			actual_num() {
				var a_num = this.num * this.usdt_to_slc_scale;
				return a_num;
			}
		}
	}
