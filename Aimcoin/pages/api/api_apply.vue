<template>
	<view class="pages" :data-theme="pageTheme">
		...
		<view class="main">
			<view class="titleBox">
				<view class="titleBox-wrapper">
					...
					<view class="titleBox-note">{{ $store.state.projectName }}仅为您的账户提供数据查询与自动交易服务，我们不会以任何形式泄露</view>
				</view>
			</view>
		...
		<view class="initButton initButton--fixed"><view class="initButton-btn initButton-btn--style" @click="bindBourse()">提交绑定</view></view>
	</view>
</template>
