	...
	<view class="pages">
		<view class="initHeader initHeader--black">
			<view class="initHeader-wrapper">
				<view class="initHeader-back" @click="initBack()"></view>
		...
		<view class="main">
			...
			<view class="initButton"><view class="initButton-btn initButton-btn--golden" @click="unloadImg()">提交审核</view></view>
			<!-- <view class="tipsBox">
...
export default {
	data() {
		return {
			authInfo: [],
			uploadList: { src1: '../../static/authentication/img-authentication-1.png', src2: '../../static/authentication/img-authentication-2.png', src3: '../../static/authentication/img-authentication-3.png' },
			userUploadList: { src1: '../../static/authentication/img-authentication-1.png', src2: '../../static/authentication/img-authentication-2.png', src3: '../../static/authentication/img-authentication-3.png' }
		};
	},
	onShow() {
		this.init();
