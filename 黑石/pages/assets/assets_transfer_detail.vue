	...
	<view class="pages">
		...
		<view class="infoBox">
			<view class="infoBox-wrapper">
				<view class="infoBox-label">{{ detailInfo.currencyName }}({{ detailInfo.type == 1 ? '转出' : '转入' }})</view>
		...
		<view class="listBox">
			<view class="listBox-wrapper">
				<view class="listBox-list">
					...
					<view class="listBox-list__data">{{ detailInfo.type == 1 ? '转出' : '转入' }}</view>
				</view>
				<view class="listBox-list">
				...
				<view class="listBox-list">
					<view class="listBox-list__label">手续费</view>
